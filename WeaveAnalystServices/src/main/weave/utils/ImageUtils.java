/** utility class taken from ben-bai123
 * Reference
...
package weave.utils;
	...
	public class ImageUtils {
	    ...
	    public static void main (String args[]) throws IOException {
	        ...
	        BufferedImage img = ImageIO.read(new File("C:/Users/Shweta/Desktop/Analysis.png"));
	        BufferedImage newImg;
	        String imgstr;
	        imgstr = encodeToString(img, "png");
	        System.out.println(imgstr);
	        newImg = decodeToImage(imgstr);
	        ImageIO.write(newImg, "png", new File("C:/Users/Shweta/Desktop/CopyOfTestImage.png"));
