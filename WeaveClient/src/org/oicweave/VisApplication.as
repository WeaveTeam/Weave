...
package org.oicweave
{
	...
	import org.oicweave.KeySetContextMenuItems;
	import org.oicweave.Reports.WeaveReport;
	import org.oicweave.SearchEngineUtils;
	...
	import org.oicweave.compiler.BooleanLib;
	import org.oicweave.compiler.MathLib;
	import org.oicweave.core.DynamicState;
	...
	import org.oicweave.services.LocalAsyncService;
	import org.oicweave.services.ProgressIndicator;
	import org.oicweave.services.URLRequestUtils;
	import org.oicweave.ui.AlertTextBox;
	import org.oicweave.ui.AlertTextBoxEvent;
	import org.oicweave.ui.AttributeSelectorPanel;
	import org.oicweave.ui.AutoResizingTextArea;
	import org.oicweave.ui.ColorBinEditor;
	import org.oicweave.ui.CustomContextMenuManager;
	import org.oicweave.ui.DatasetLoader;
	import org.oicweave.ui.DraggablePanel;
	import org.oicweave.ui.EquationEditor;
	import org.oicweave.ui.ErrorLogPanel;
	import org.oicweave.ui.ExportSessionStatePanel;
	import org.oicweave.ui.NewUserWizard;
	import org.oicweave.ui.OICLogoPane;
	import org.oicweave.ui.PrintFormat;
	import org.oicweave.ui.ProbeToolTipEditor;
	import org.oicweave.ui.RTextEditor;
	import org.oicweave.ui.SelectionManager;
	import org.oicweave.ui.SessionStateEditor;
	import org.oicweave.ui.SessionStatesDisplay;
	import org.oicweave.ui.SubsetManager;
	import org.oicweave.ui.WizardPanel;
	import org.oicweave.ui.annotation.SessionedTextBox;
	import org.oicweave.ui.controlBars.VisTaskbar;
	import org.oicweave.ui.controlBars.WeaveMenuBar;
	import org.oicweave.ui.controlBars.WeaveMenuItem;
	import org.oicweave.ui.editors.AddDataSourceComponent;
	import org.oicweave.ui.editors.EditDataSourceComponent;
	import org.oicweave.ui.settings.GlobalUISettings;
	import org.oicweave.utils.BitmapUtils;
	import org.oicweave.utils.CSSUtils;
	import org.oicweave.utils.DebugUtils;
	import org.oicweave.utils.DrawUtils;
	import org.oicweave.utils.NumberUtils;
	import org.oicweave.visualization.tools.ColorBinLegendTool;
	import org.oicweave.visualization.tools.CompoundBarChartTool;
	import org.oicweave.visualization.tools.DataTableTool;
	import org.oicweave.visualization.tools.DimensionSliderTool;
	import org.oicweave.visualization.tools.GaugeTool;
	import org.oicweave.visualization.tools.HistogramTool;
	import org.oicweave.visualization.tools.LineChartTool;
	import org.oicweave.visualization.tools.MapTool;
	import org.oicweave.visualization.tools.PieChartHistogramTool;
	import org.oicweave.visualization.tools.PieChartTool;
	import org.oicweave.visualization.tools.RadViz2Tool;
	import org.oicweave.visualization.tools.RadVizTool;
	import org.oicweave.visualization.tools.RamachandranPlotTool;
	import org.oicweave.visualization.tools.SP2;
	import org.oicweave.visualization.tools.ScatterPlotTool;
	import org.oicweave.visualization.tools.StickFigureGlyphTool;
	import org.oicweave.visualization.tools.ThermometerTool;
	import org.oicweave.visualization.tools.TimeSliderTool;
	import org.oicweave.visualization.tools.WeaveWordleTool;
...
//		[Embed("/org/oicweave/resources/images/panelButtonEnlarged.png")]
//		public var panelButton:Class;
//		[Embed("/org/oicweave/resources/images/panelButtonRed.png")]
//		public var panelButtonRed:Class;
//		[Embed("/org/oicweave/resources/images/panelButtonBlue.png")]
...
//					PopUpManager.removePopUp(_visTaskbar);
		...
		private function loadSessionState(state:XML):void
		{
			...
			{
				stateStr = stateStr.replace("org.openindicators", "org.oicweave");
				state = XML(stateStr);
			}
			var tag:XML;
		...
		private function setupWindowMenu():void
		{
			...
			/*_visMenu.addMenuItemToMenu(_windowMenu, new VisMenuItem("Tile All Windows", null, null, null,false), true);//, "org.oicweave.resources.images.arrowLeft.png"));
