...
package weave.api.ui
{
	...
	/**
	 * This interface describes a plotter which contains drawn geometries 
	 * not tied to the data source. The geometries can be used to query records.
	 * 
	 * @author kmonico
	 */
	public interface IPlotterWithGeometrySelection extends IPlotter
	{
		/**
		 ...
		 */		
		function getSelectableGeometries():Vector.<ISimpleGeometry>;
	}
}