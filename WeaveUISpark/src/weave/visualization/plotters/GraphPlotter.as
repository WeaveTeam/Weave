...
//		}
		...
		public const graphIsDirected:LinkableBoolean = registerLinkableChild(this, new LinkableBoolean(false)); // should we assume that the graph is directed for the purposes of layout and rendering?
