...
//				}
	...
	public static void main(String[] args) throws Exception
	{
		...
		String scriptPath = "C:\\Users\\Shweta\\Desktop\\BioC.r";
		String [] inputNames = {"cannedScriptPath"};
		//Object[] inputValues = new Object[0];
		Object[] inputValues = {scriptPath};
		
		String script = "scriptFromFile <- source(cannedScriptPath)\n" +
		 "answer <- scriptFromFile$value\n";
		String[] resultNames = {"answer"};
