...
package org.oicweave.visualization.plotters
{
	...
	import org.oicweave.primitives.LinkableNumberFormatter;
	import org.oicweave.primitives.LooseAxisDescription;
...
//				trace(this,'drawPlot',arguments);
			...
			for (var i:int = 0; i < recordKeys.length; i++)
			{
				...
				graphics.clear();
				graphics.lineStyle(axisGridLineThickness.value, axisGridLineColor.value, axisGridLineAlpha.value);
