	...
	public class CompoundPlotter extends AbstractPlotter
	{
		...
		private function handlePlottersListChange():void
		{
			...
			if (newPlotter)
			{
				...
				newPlotter.spatialCallbacks.addImmediateCallback(this, spatialCallbacks.triggerCallbacks); // this is not a parent-child relationship, so alwaysCallLast=false
			}
