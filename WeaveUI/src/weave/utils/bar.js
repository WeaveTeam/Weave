(function(){
	...
	generateBarChart = function(barData)
	{
		setData(barData.yDataArray, barData.axisMax, barData.axisMin);
		setXgrid(barData.xTicks, barData.xAxisMax, barData.xAxisMin);
		setYgrid(barData.yTicks, barData.axisMax, barData.axisMin);
		setWidthAndHeight(barData.width, barData.height);
		setMargins(barData.marginTop, barData.marginLeft, barData.marginBottom, barData.marginRight);
		setTitles(barData.title, barData.yTitle, barData.xTitle);
		draw();
	}
})();
