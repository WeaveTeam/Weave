package weave.services.collaboration
{
	...
	public class WeaveExtension extends Extension implements IExtension, ISerializable
	{
		...
		public static var REQUEST_PROFILE_PIC:String = "requestprofilepic";
		public static var REQUEST_MOUSE_CONTROL:String = "requestmousecontrol";
		public static var RELINQUISH_MOUSE_CONTROL:String = "relinquishmousecontrol";
		...
		public static var PROFILE_PIC_MESSAGE:String = "profilepicmessage";
		public static var ADDON_STATUS:String = "addonstatus";
		public static var MICROPHONE_ACTIVITY:String = "microphoneactivity";
