...
public class OauthService extends AbstractAuthorizationCodeService {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
	 ...
	 public void triggerOauthFlowWithResponse(String clientID,String clientSecret, String authUri, String tokenUri,HttpServletResponse resp,HttpServletRequest req) throws IOException, ServletException {
		    lock.lock();
		    try {
		        if (flow == null) {
		        flow = initializeFlow(clientID,clientSecret,authUri,tokenUri);
