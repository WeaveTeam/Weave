package weave.utils
{
	...
	public function fixErrorMessage(error:Error):void
	{
		if (!Capabilities.isDebugger && error.message == "Error #" + error.errorID && FlashErrorCodes[error.errorID])
			error.message += ": " + FlashErrorCodes[error.errorID];
	}
}
...
internal const FlashErrorCodes:Object = {
	...
	"1085": "The element type \"%S\" must be terminated by the matching end-tag \"%S\".",
	...
	"3725": "The requested AGAL version (%2) is not valid under the Context3D profile. For example AGAL version 2 requires extended profile.",
