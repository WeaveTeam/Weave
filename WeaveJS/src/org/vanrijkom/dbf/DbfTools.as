...
public class DbfTools
{
	 ...
	 * 
	 */	
	public static function readZeroTermANSIString(src: JSByteArray): String {
		var r: String = "";
		var b: int;
		while (true) {
	 ...
	 * 
	 */	
	public static function readANSIString(src: JSByteArray, length: uint): String {
		var r: String = "";
		while(length--) {
	 ...
	 * 
	 */	
	public static function getRecord(src: JSByteArray, header: DbfHeader, index: uint): DbfRecord {
