...
package weavejs.api.service
{
	...
	public interface IURLRequestUtils
	{
		 ...
		 */
		function getURL(relevantContext:Object, request:Object, dataFormat:String = "binary", allowMultipleEvents:Boolean = false):WeavePromise;
		 ...
		 * @see weave.api.core.IProgressIndicator#addTask()
		 */
		function getContent(relevantContext:Object, request:Object, useCache:Boolean = true):WeavePromise;
		 ...
		 */
		function saveLocalFile(name:String, content:Object):String;
		 ...
		 */
		function getLocalFile(name:String):Object;
