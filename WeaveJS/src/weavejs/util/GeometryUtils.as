...
{	
	...
	{
		/**
		 * Implementation of AS3's ObjectUtil.numericCompare: Compares two numeric values.
		 */
		private static function numericCompare(a:Number, b:Number):int
		{
		 ...
		 */
		public static function lineIntersectsLine(x1:Number, y1:Number, x2:Number, y2:Number, x3:Number, y3:Number, x4:Number, y4:Number, output:Object = null, ABasSeg:Boolean=true, EFasSeg:Boolean=true):Object/*/{x: number, y: number}/*/
		{
			// we have two lines
		...
		// reusable objects
		private static const _tempMinPoint:Object = {x: 0, y: 0};
		private static const _tempMaxPoint:Object = {x: 0, y: 0};		
		private static const _tempBounds:Bounds2D = new Bounds2D();
		private static const _tempVectorPoint:Object = {x: 0, y: 0};
		 ...
		 */
		public static function lineIntersectsLine2(Ax:Number, Ay:Number, Bx:Number, By:Number, Ex:Number, Ey:Number, Fx:Number, Fy:Number, outputIntersectionPoint:Object/*/{x: number, y: number}/*/=null, ABasSeg:Boolean=true, EFasSeg:Boolean=true):Object/*/{x: number, y: number}/*/
		{
			...
			if (outputIntersectionPoint == null)
				outputIntersectionPoint = {x: 0, y: 0};
			...
			while (pointIndex--)
			{
				...
				if (lineIntersectsLine(x, y, x + 1, y, Ax, Ay, Bx, By, tempPoint, false) != null && tempPoint.x >= x)
				{
					...
					if (tempPoint.y == Ay && tempPoint.x == Ax)
						segSide = numericCompare(tempPoint.y, By);
					else if (tempPoint.y == By && tempPoint.x == Bx)
						segSide = numericCompare(tempPoint.y, Ay);
					else
						segSide = 0;
		...
		private static const tempPoint:Object = {x: 0, y: 0};
